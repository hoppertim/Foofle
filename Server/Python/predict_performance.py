...
import sys
sys.path.append('E:/xampp/htdocs/Python/QB Model')
sys.path.append('E:/xampp/htdocs/Python/RB Model')
sys.path.append('E:/xampp/htdocs/Python/WR Model')
sys.path.append('E:/xampp/htdocs/Python/TE Model')
sys.path.append('E:/xampp/htdocs/Python/K Model')
sys.path.append('E:/xampp/htdocs/Python/DEF Model')
...
prev_weights = {'prev2': .25, 'prev5': .3, 'season': .3, 'prevseason': .15, 'career': .1}
...
class Predictor:
	...
	def predict(self, player_id = '', team_id = '', gsis_id = '', points = 0):
		...
		if player_id:
			...
			if rows[0]['position'].name == 'QB':
				return self._QB_predict(rows, player_id, gsis_id, points)
	...
	def _QB_predict(self, prev, player_id, gsis_id, points):
		#File name of the naive bayes model for QB's
		file_name = 'E:/xampp/htdocs/Python/QB Model/qb_naive.json'
		...
		return .65*estimate_model['points'] + .2*estimate_model['calc_points'] + .15 * (prev_points / 1.1)
	...
	def _RB_predict(self, prev, player_id, gsis_id):
		...
		file_name = 'E:/xampp/htdocs/Python/RB Model/rb_naive.json'
	...
	def _WR_predict(self, prev, player_id, gsis_id):
		#File name of the naive bayes model for RB's
		file_name = 'E:/xampp/htdocs/Python/WR Model/wr_naive.json'
	...
	def _TE_predict(self, prev, player_id, gsis_id):
		#File name of the naive bayes model for RB's
		file_name = 'E:/xampp/htdocs/Python/TE Model/te_naive.json'
	...
	def _K_predict(self, prev, player_id, gsis_id):
		#File name of the naive bayes model for QB's
		file_name = 'E:/xampp/htdocs/Python/K Model/k_naive.json'
	...
	def _DEF_predict(self, prev, team_id, gsis_id):
		#File name of the naive bayes model for QB's
		file_name = 'E:/xampp/htdocs/Python/DEF Model/def_naive.json'
...
if __name__ == '__main__':
	...
	for index in range(1,14):
		...
		for r in rows:
			points = p.predict(r['player_id'], r['team_id'], r['gsis_id'], r['points'])
